...
public class PageableEditor extends StyledEditorKit {

    PageableViewFactory factory = new PageableViewFactory();

    //z-index: 0; width: 816px; height: 1056px;
    protected int dpi = Toolkit.getDefaultToolkit().getScreenResolution();
    protected int pageWidth = 816;
    protected int pageHeight = 1056;
    public static int DRAW_PAGE_INSET = 15;
    protected Insets pageMargins = new Insets(10, 10, 10, 10);
    protected Insets headerMargins = new Insets(dpi, dpi, Math.round(pageHeight - dpi), dpi);

    /**
     * Constructs kit instance
     */
    public PageableEditor() {
    }
    ...
    public static void main(String[] args) {
        new PageableEditor().init().setVisible(true);
    }
    ...
    class PageableParagraphView extends ParagraphView implements MultiPageView {
        ...
        public PageableParagraphView(Element elem) {
            ...
            setInsets((short) 0, (short) 0, (short) pageHeight, (short) pageWidth);
            setPageMargins(headerMargins);
        }
