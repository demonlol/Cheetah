...
public class PBKDF2WithHmacSHA512 implements KeyEncryption {

    private static PBKDF2WithHmacSHA512 instance;
    public static PBKDF2WithHmacSHA512 getInstance() { return instance == null ? (instance = new PBKDF2WithHmacSHA512()) : instance; }
    ...
    public String decrypt(String string, SecretKeySpec key) throws GeneralSecurityException, IOException {
        ...
        Cipher pbeCipher = Cipher.getInstance("PBKDF2WithHmacSHA512/CBC/PKCS5Padding");
    ...
    public SecretKeySpec createSecretKey(char[] password, byte[] salt, int iterationCount, int keyLength) throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        return new SecretKeySpec(keyTmp.getEncoded(), "PBKDF2WithHmacSHA512");
    }
